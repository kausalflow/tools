...
summary: "Gold Digger is a command-line tool for snowballing literature search, starting from a few initial papers. It uses the Semantic Scholar API to find citations and references, and provides a flexible filtering mechanism to narrow down the results."
features:
...
makers: # the makers of the tool
  - name:
    description:
author: Amir Khaki   # the person who submitted this tool to KausalFlow
date: 2025-12-18
draft: false
---
